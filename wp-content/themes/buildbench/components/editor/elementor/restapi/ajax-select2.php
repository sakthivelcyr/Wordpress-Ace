...
function BUILDBENCH_ajax_select_func( WP_REST_Request $request ) {
    $class = new BUILDBENCH_ajax_Api();
...
add_action( 'rest_api_init', function () {
    register_rest_route( 'ajaxselect2/v1', '/(?P<method>\w+)/', array(
        'methods' => 'GET',
        'callback' => 'BUILDBENCH_ajax_select_func',
    ));
});